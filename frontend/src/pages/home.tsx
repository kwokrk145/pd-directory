...
export const Home = () => {
  ...
  return (
    <div className="w-full bg-[#300811]">
      <div className="h-px bg-[#f0cf86]/18" />

      <section className="bg-[#300811] py-4">
        <div className="mx-auto flex min-h-[50vh] w-full max-w-7xl flex-col items-center justify-center gap-12 px-6 py-16 text-center md:px-8">
          ...
          <div className="space-y-8">
            <h1 className="text-center font-serif text-5xl leading-tight text-[#fff8ee]">
      ...
      <section className="bg-[#571120] font-serif text-3xl text-[#fff8ee]">
        <div className="mx-auto flex w-full max-w-7xl flex-row items-center justify-center">
          <div className="flex h-[20vh] w-1/3 flex-col justify-center border border-[#f0cf86]/12 text-center">
            <h1>
              240+
            </h1>
      ...
      <section className="bg-[#300811] px-6 py-20 md:px-12 xl:px-24">
        <div className="mx-auto flex w-full max-w-7xl flex-col items-start gap-4">
          ...
          <h1 className="text-lg font-serif text-[#e2c8b1]">
          ...
          <div className="grid w-full grid-cols-1 gap-6 pt-5 sm:grid-cols-2 xl:grid-cols-4">
