...
export const Card = (props: CardProps) => {
    return (
        <div className="flex h-60 w-60 flex-col justify-center gap-2 rounded-xl border border-[#f0cf86]/14 bg-[#571120] px-8 font-serif shadow-[0_20px_45px_-30px_rgba(0,0,0,0.75)]">
            ...
            <h1 className="text-[#fff8ee]">{props.name}</h1>
